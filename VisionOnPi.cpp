...
void Threshold()
{
	...
	inRange(frameGray, 140, 255, frameThresh); // 137 looked good indoors at night, 165 looked good indoors during the day
...
int main(int argc, char **argv)
{
	...
	while(1) {
		...
		// stay straight. we are sending binary values to arduino
		if (Result == 0)
		{
			digitalWrite(21, 0);
			digitalWrite(22, 0);
		...
		else if (Result > 0 && Result < 10) // sends decimmal value of 1
		{
			digitalWrite(21, 1);
			digitalWrite(22, 0);
			digitalWrite(23, 0);
		...
		else if (Result >= 10 && Result < 20) // sends decimal value of 2
		{
			digitalWrite(21, 0);
			digitalWrite(22, 1);
			digitalWrite(23, 0);
			digitalWrite(24, 0);
			cout<<"Normal Right Turn"<<endl;
		}
		
		else if (Result >= 20) // sends decimal value of 3
		{
			digitalWrite(21, 1);
			digitalWrite(22, 1);
			digitalWrite(23, 0);
			digitalWrite(24, 0);
			cout<<"Hard Right Turn"<<endl;
		}
		
		else if (Result < 0 && Result > -10) // sends decimmal value of 4
		{
			digitalWrite(21, 0);
			digitalWrite(22, 0);
			digitalWrite(23, 1);
		...
		else if (Result <= -10 && Result > -20) // sends decimal value of 5
		{
			digitalWrite(21, 1);
			digitalWrite(22, 0);
			digitalWrite(23, 1);
			digitalWrite(24, 0);
			cout<<"Normal Left Turn"<<endl;
		}
		
		else if (Result <= -20) // sends decimal value of 6
		{
			digitalWrite(21, 0);
			digitalWrite(22, 1);
			digitalWrite(23, 1);
			digitalWrite(24, 0);
			cout<<"Hard Left Turn"<<endl;
		}
